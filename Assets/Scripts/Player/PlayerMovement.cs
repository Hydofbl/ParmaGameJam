...
public class PlayerMovement : MonoBehaviour {
    ...
    [SerializeField] private float xSensitivity = 8f;
    ...
    public void ReceiveMovementInput(Vector2 _movementInput)
    {
        /*
        // Raw Axis
        x = _movementInput.x;
    ...
    {
        mouseX = mouseInput.x * xSensitivity * Time.fixedDeltaTime * sensMultiplier;
        mouseY = mouseInput.y * ySensitivity * Time.fixedDeltaTime * sensMultiplier;
    }
